...
import { Archive, ArrowLeft, BookOpen, Check, ChevronDown, CircleHelp, Cloud, Copy, Download, FilePlus2, Filter, Folder, FolderPlus, Hash, Link2, Menu, Moon, Network, NotebookPen, Plus, Search, Settings, Share2, Sparkles, SquareDashed, Star, Sun, Trash2, Upload, X } from 'lucide-react'
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="content">
        {view === 'notes' && <NotesView workspace={workspace} folderId={selectedFolder} onOpen={openNote} onCreate={createNote} update={update}/>}
...
function NotesView({ workspace, folderId, onOpen, onCreate, update }: { workspace: Workspace; folderId: string | null; onOpen: (id: string) => void; onCreate: () => void; update:(fn:(w:Workspace)=>Workspace)=>void }) {
