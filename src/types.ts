...
export interface Note {
  ...
  sourceIds: string[]; status: NoteStatus; favorite: boolean; color: string; createdAt: string; updatedAt: string;
}
...
export interface GraphNode { id: string; rawId: string; kind: GraphKind; label: string; x: number; y: number; color: string; count?: number }
